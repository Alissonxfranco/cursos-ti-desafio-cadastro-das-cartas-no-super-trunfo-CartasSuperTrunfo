...
int main() {
    ...
    //variaveis de calculo cidade 1
    float densidade1;
    float riqueza1;

    //variaveis de calculo cidade 2
    float densidade2;
    float riqueza2;
    ...
    //__calculos adicionais__
    densidade1 = populacao1 / area1;
    densidade2 = populacao2 / area2;

    //calculo de riqueza
    //multiplica-se o valor de pib por 1 milhao para converter em reais levando em consideraçao que foi digitado o valor em "bilhoes"
    //após a multiplicao sera realizada a divisao pelo valor da populaçao
    riqueza1 = (pib1 * 1000000000) / populacao1;
    riqueza2 = (pib2 * 1000000000) / populacao2;
